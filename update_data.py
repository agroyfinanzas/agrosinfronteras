...
def actualizar():
    ...
    # Inyección AGRESIVA de Indicadores (Busca el ID y reemplaza todo el contenido)
    def escribir_fuerte(id_n, id_b, val, tipo):
        nonlocal h
    ...
    escribir_fuerte("rel-u-s", "ind-u-s", r_u_s, "urea")
    escribir_fuerte("rel-u-m", "ind-u-m", r_u_m, "urea")
    escribir_fuerte("rel-g-s", "ind-g-s", r_g_s, "gas")
    escribir_fuerte("rel-g-m", "ind-g-m", r_g_m, "gas")
    escribir_fuerte("rel-c-t", "ind-c-t", r_c_t, "carne")
    escribir_fuerte("rel-c-n", "ind-c-n", r_c_n, "carne")
